...
This experiment runs a fairly simple experiment wherein the model is tasked with completing a sequence of letters
...
for i in range(num_experiments):
    ...
    device = 'cpu'
    probs = test_input_string(model_name, ans, string_to_feed, judgement_func=judge_on_alphabet, device=device, lr=2e-3, num_iter=2)
    orig = probs[0].item()
